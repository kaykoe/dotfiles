...
main() {
	...
	"Choose Kitty Terminal Theme") $waylandScripts/Kitty_themes.sh ;;
	"Configure Monitors (nwg-displays)")
	...
	"Choose Rofi Themes") $waylandScripts/RofiThemeSelector.sh ;;
	"Search for Keybinds") $waylandScripts/KeyBinds.sh ;;
	"Toggle Game Mode") $scriptsDir/GameMode.sh ;;
	"Switch Dark-Light Theme") $waylandScripts/DarkLight.sh ;;
